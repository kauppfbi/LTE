...
/**
 * The class ThreadPlay extends thread and represents a set against another AI.
 * It communicates with the AI the chosen interface and the settings and
 * GameInfo object.
 * 
		...
		while (true) {
			...
			// ***** wir spielen Zug *****
				...
				try {
					...
					int nextMove = algorithmManager.ParallelAlphaBeta(currentGameScore.getField(), 10,
